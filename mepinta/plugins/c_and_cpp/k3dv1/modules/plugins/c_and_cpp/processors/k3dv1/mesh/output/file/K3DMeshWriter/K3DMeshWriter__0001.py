...
'''
from plugins.c_and_cpp.processors.k3dv1.mesh.output.file.base.MeshWriterManifestBase import MeshWriterManifestBase

class K3DMeshWriter(MeshWriterManifestBase):
  def define(self, inputs, internals, functions, outputs, writeMesh):
    pass

manifest = K3DMeshWriter
