...
#ifndef SIMPLEGEOMETRYMODIFIER_H_
#define SIMPLEGEOMETRYMODIFIER_H_
...
namespace mesh {
  class SimpleGeometryModifierBase:
  ...
  public:
    ...
    int demuxMeshSignal_unpackAndRun(){
      ...
      if(update_mesh_changed or in_mesh_changed){
...
#endif /* SIMPLEGEOMETRYMODIFIER_H_ */
