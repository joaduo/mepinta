...
def createK3dv1PortAndImport(modules, overwrite=False, config_options={}):
  ...
  for plugin_module in modules:
    createPluginQt(plugin_module, qt_projects_root, translation_dict={}, overwrite=overwrite)
...
def createK3dv1Port(modules, overwrite=False):
  ...
  for plugin_module in modules:
    createPluginQt(plugin_module, qt_root, translation_dict={}, overwrite=overwrite)
