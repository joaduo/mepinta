...
class PolyCube(MeshSourceManifestBase):
    ...
    def define(self, inputs, internals, functions, outputs, updateMeshTopology, updateMeshGeometry):
        ...
        # Set dependencies
        updateMeshTopology.dpdencies += [inputs.rows                                         , inputs.columns                                          , inputs.slices]
        updateMeshGeometry.dpdencies += [inputs.rows                                         , inputs.columns                                          , inputs.slices                                          , inputs.width                                          , inputs.height                                          , inputs.depth]
