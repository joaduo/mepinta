...
class MepintaPluginEclipseProjectCreator(FrameworkBase):
    ...
    def createK3dv1PluginProject(self, projects_dir, plugin_manifest):
        ...
        self.ep_creator.createCDT(projects_dir, project_name, config_dict=config_dict,
                                  templates_config=templates_config, template_set='cdt_k3dv1_plugin', create_src=False)
