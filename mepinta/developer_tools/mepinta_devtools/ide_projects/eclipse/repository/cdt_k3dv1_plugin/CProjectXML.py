...
from mepinta_devtools.templates.logic.TemplateXMLBase import TemplateXMLBase


class CProjectXML(TemplateXMLBase):
...
&quot;${workspace_loc:/Mepinta_k3dv1_DataTypes_Includes}&quot;'''
    ...
    def includeDirs(self):
        xml_string = self._includeXMLFromList(
            self.external_includes.splitlines())
        xml_string += self._includeXMLFromList(
            self.eclipse_includes.splitlines())
