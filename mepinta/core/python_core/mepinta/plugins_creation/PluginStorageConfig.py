...
if __name__ == "__main__":
  ...
  print(psc.project_name)
  print(psc.minor_version)
  #print(psc.getPath('eclipse'))
  print(psc.getPath('project'))
  print(psc.getPath('package'))
  print(psc.getPath('module'))
  print(psc.getPath('code'))
  print(psc.module_name_prefix)
  print(psc.getModuleName())
  print(psc.implementationLibs())
  print(psc.implementationLibs(split=True))
